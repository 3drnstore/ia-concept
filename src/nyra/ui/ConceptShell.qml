...
ApplicationWindow {
    ...
    component MetricCard: Rectangle {
        ...
        Layout.fillWidth:true; implicitHeight:58; radius:8; color:"#0a1820"; border.color:root.line
        RowLayout { anchors.fill:parent; anchors.margins:8
            Rectangle { Layout.preferredWidth:30;Layout.preferredHeight:30;radius:6;color:"#102933";Mono{anchors.centerIn:parent;text:metricIcon;color:root.cyan} }
            ColumnLayout { Layout.preferredWidth:92; spacing:0
                Mono{text:metricLabel+" // "+metricValue;color:root.ink;font.pixelSize:8}
                Mono{text:metricStatus;font.pixelSize:7;elide:Text.ElideRight;Layout.maximumWidth:90}
            }
    ...
    component Orb: Item {
        ...
        Canvas { id:orbCanvas; anchors.fill:parent
            onPaint:{
                ...
                var rad=Math.min(width*.27,height*.42),g=c.createRadialGradient(cx,cy,1,cx,cy,rad);g.addColorStop(0,"#ffffff");g.addColorStop(.045,"#bfffff");g.addColorStop(.12,"#31eff8");g.addColorStop(.27,"#0aaec2");g.addColorStop(.48,"#086276");g.addColorStop(.7,"#071d27");g.addColorStop(1,"#02070b00");c.fillStyle=g;c.beginPath();c.arc(cx,cy,rad,0,6.283);c.fill();
    ...
    Item { anchors.left:parent.left;anchors.right:parent.right;anchors.top:topbar.bottom;anchors.bottom:parent.bottom
        ...
        Item { anchors.fill:parent; visible:!root.compactMode
            RowLayout { anchors.left:parent.left;anchors.right:parent.right;anchors.top:parent.top;anchors.bottom:commandDock.top;anchors.margins:12;anchors.bottomMargin:10;spacing:12
                ...
                Rectangle { Layout.preferredWidth:265; Layout.fillHeight:true; color:"#061016"; radius:14; border.color:root.line
                    ColumnLayout { anchors.fill:parent; anchors.margins:16; spacing:9
                        ...
                        MetricCard{metricLabel:"CPU";metricValue:Math.round(systemMonitor.cpuPercent)+"%";metricStatus:"NORMAL";metricIcon:"▧";metricValues:systemMonitor.cpuHistory}
                        MetricCard{metricLabel:"VOICE";metricValue:root.talking?"TALKING":"READY";metricStatus:"NYRA OUTPUT";metricIcon:"♩";metricValues:systemMonitor.voiceHistory}
                        MetricCard{metricLabel:"LOCAL DB";metricValue:systemMonitor.dbSize;metricStatus:"SYNC";metricIcon:"▰";metricValues:[24,31,19,43,28,48,22,36,27,41]}
                    }
                }
            ...
            // footer command dock
            Rectangle{id:commandDock;anchors.left:parent.left;anchors.right:parent.right;anchors.bottom:parent.bottom;height:76;color:"#061118";border.color:root.line;radius:10
                RowLayout{anchors.fill:parent;spacing:0
                    Rectangle{Layout.preferredWidth:205;Layout.fillHeight:true;color:"#050d13";border.color:root.line;RowLayout{anchors.fill:parent;anchors.margins:14;spacing:10;Label{text:"⊞";color:root.ink;font.pixelSize:24}ColumnLayout{spacing:0;Mono{text:"22:43";color:root.ink;font.pixelSize:8}Mono{text:"25 MAI 2025";font.pixelSize:7}}Item{Layout.fillWidth:true}Label{text:"☁";color:root.ink;font.pixelSize:18}ColumnLayout{spacing:0;Mono{text:"19°C";color:root.ink;font.pixelSize:8}Mono{text:"NUBLADO";font.pixelSize:7}}}}
                    RowLayout{Layout.fillWidth:true;Layout.fillHeight:true;Layout.leftMargin:18;Layout.rightMargin:14;spacing:13;Wave{Layout.preferredWidth:28;Layout.preferredHeight:34;active:root.talking}Rectangle{Layout.preferredWidth:1;Layout.preferredHeight:40;color:root.cyan}Label{text:"> Fale ou digite um comando...";color:root.muted;font.pixelSize:14;Layout.fillWidth:true}Rectangle{Layout.preferredWidth:1;Layout.preferredHeight:28;color:root.line}Mono{text:"ESC para cancelar"}Rectangle{Layout.preferredWidth:56;Layout.preferredHeight:56;radius:28;color:"#06303c";border.width:2;border.color:root.cyan;Rectangle{anchors.centerIn:parent;width:34;height:34;radius:17;color:"#0a5363";border.color:"#12859a";Label{anchors.centerIn:parent;text:"●";color:root.cyan;font.pixelSize:15}}}CButton{text:"⋮";Layout.preferredWidth:40;Layout.preferredHeight:40}}
                }
            }
        }
            ...
            Column {
                ...
                Panel {
                    ...
                    Column { anchors.fill:parent;anchors.margins:14;spacing:7
                        ...
                        Repeater { model:["⌂   Hoje","▤   Demandas","◉   Memória","▭   Arquivos","◴   Rotinas","⚙   Configurações"]
                            CButton { width:parent.width;height:34;text:modelData;accent:index===0 }
                        }
